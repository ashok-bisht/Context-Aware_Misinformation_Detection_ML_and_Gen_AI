...
st.caption("AWS S3 (models + knowledge base + logs) \u00b7 Naive Bayes (TF-IDF) \u00b7 sentiment Analysis \u00b7 Groq (free LLM) \u00b7 Tableau Public")
...
with st.sidebar:
    ...
    model_key = st.text_input("Model key", value="models-pkl-file/naive_bayes_model.pkl")
    ...
    if st.button("Analyze", type="primary"):
        if not claim_text.strip():
            ...
            try:
                ...
                # MultinomialNB stores whatever label strings it was trained on
                # in model.classes_, so no hardcoded 0/1 mapping is needed.
